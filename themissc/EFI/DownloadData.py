...
def DownloadData(sc='a',Prod='EFI',L='2',Date=[20070101,20210101],Overwrite=False,Verbose=True):
	'''
	Downloads EFI data.
	...
	'''
	URLF = URL(sc,Prod,L)
	_DownloadData(URLF,_EFI.idxfname.format(Prod,L,sc),_EFI.datapath.format(Prod,L,sc),
			Date,_EFI.vfmt,None,Overwrite,Verbose)
