...
def ReadCDF(Date,sc='a',Prod='GMOM',L='2'):
	'''
	Inputs
	======
	sc : str
	...
	#read the data index
	idx = _ReadDataIndex(_GMOM.idxfname.format(Prod,L,sc))
	...
	#get the file name
	fname = os.path.join(_GMOM.datapath.format(Prod,L,sc),idx[mx].FileName)
